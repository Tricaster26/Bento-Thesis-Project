...
from utility import LoadDataBentoCW
...
description = "Training and evaluating DF model for closed-world scenario on non-defended dataset BENTO"
...
NB_CLASSES = 2039 # number of outputs = number of classes
INPUT_SHAPE = (LENGTH,1)


# Data: shuffled and split between train and test sets
print ("Loading and preparing data for training, and evaluating the model")
X_train, y_train, X_valid, y_valid, X_test, y_test = LoadDataBentoCW()
...
model.save('ClosedWorld_VanillaTor_Bento')
print('Saved model to: ClosedWorld_VanillaTor_Bento')
